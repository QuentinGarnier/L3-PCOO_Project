...
public class TabModel extends AbstractTableModel {
    ...
    TabModel() {
        ...
        students.add(new Student(21603566, "Nicolas", "Van de Kampf"));
        ...
        students.add(new Student(21603561, "Eric", "Trump"));
        students.add(new Student(21603560, "Erica", "Juil"));
        students.add(new Student(21603568, "Michel", "Michel"));
        students.add(new Student(21603569, "Ziami", "Markalopolof"));
    }
